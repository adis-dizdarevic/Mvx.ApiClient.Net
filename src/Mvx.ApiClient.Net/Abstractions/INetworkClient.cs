...
public partial interface INetworkClient
{
    ...
    Task<EconomicsDto> GetEconomicsAsync(CancellationToken cancellationToken = default);
    ...
    Task<NetworkConstantsDto> GetConstantsAsync(CancellationToken cancellationToken = default);
