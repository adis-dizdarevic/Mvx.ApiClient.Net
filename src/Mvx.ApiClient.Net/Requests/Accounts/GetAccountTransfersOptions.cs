...
public sealed class GetAccountTransfersOptions
{
    ...
    public GetAccountTransfersOptionsStatus? Status { get; init; }
    ...
    public GetAccountTransfersOptionsOrder? Order { get; init; }
