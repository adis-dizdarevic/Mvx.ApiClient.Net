...
public sealed class GetCollectionTransactionsOptions
{
    ...
    public GetCollectionTransactionsOptionsStatus? Status { get; init; }
    ...
    public GetCollectionTransactionsOptionsOrder? Order { get; init; }
