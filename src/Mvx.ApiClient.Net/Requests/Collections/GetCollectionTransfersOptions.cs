...
public sealed class GetCollectionTransfersOptions
{
    ...
    public GetCollectionTransfersOptionsStatus? Status { get; init; }
    ...
    public GetCollectionTransfersOptionsOrder? Order { get; init; }
