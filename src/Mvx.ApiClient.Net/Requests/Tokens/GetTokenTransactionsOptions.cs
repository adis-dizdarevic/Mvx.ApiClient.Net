...
public sealed class GetTokenTransactionsOptions
{
    ...
    public GetTokenTransactionsOptionsStatus? Status { get; init; }
    ...
    public GetTokenTransactionsOptionsOrder? Order { get; init; }
