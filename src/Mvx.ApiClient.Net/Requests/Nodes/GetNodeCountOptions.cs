...
public sealed class GetNodeCountOptions
{
    ...
    public GetNodeCountOptionsType? Type { get; init; }

    /// <summary>Gets or sets the <c>status</c> filter.</summary>
    public GetNodeCountOptionsStatus? Status { get; init; }
    ...
    public GetNodeCountOptionsSort? Sort { get; init; }

    /// <summary>Gets or sets the <c>order</c> filter.</summary>
    public GetNodeCountOptionsOrder? Order { get; init; }
