...
public interface INetworkClient
{
    ...
    Task<StatsDto> GetNetworkStatsAsync(DataSelection? dataSelection = null, CancellationToken cancellationToken = default);
    ...
    Task<NetworkConstantsDto> GetNetworkConstantsAsync(DataSelection? dataSelection = null, CancellationToken cancellationToken = default);
